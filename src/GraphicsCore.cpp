...
int GraphicsCore::init()
{
    ...
    window_ = SDL_CreateWindow(
        "Raiders3D-SDL", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WINDOW_WIDTH, WINDOW_HEIGHT, IS_FULLSCREEN);
...
void bbq::GraphicsCore::drawLine(
    int x1, int y1, int x2, int y2, uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha)
{
